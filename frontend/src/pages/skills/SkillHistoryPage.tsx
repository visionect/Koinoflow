    ...
    <div className="space-y-6">
      ...
      {versionsQuery.isLoading || !versionsQuery.data ? (
            ...
            <div className="sticky top-6">
              <Card>
                ...
                <CardContent className="space-y-4 text-sm">
                  ...
                  <div className="space-y-1">
                    <p className="text-muted-foreground">Current skill owner</p>
        ...
        <EmptyState
          ...
          description="Version history will appear here as soon as the skill is saved."
        />
      )}
    </div>
  )
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          {version.change_summary ||
            (version.version_number === 1 ? "Skill created" : "No summary provided")}
        </p>
