...
> = {
  ready: {
    ...
    description: "This published version is indexed for semantic process discovery.",
  ...
  not_applicable: {
    label: "Not indexed",
    description: "Only published process versions are indexed for semantic discovery.",
