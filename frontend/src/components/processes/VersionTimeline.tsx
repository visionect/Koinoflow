...
export function VersionTimeline({ processSlug, publishedVersionNumber }: VersionTimelineProps) {
  ...
  if (!versionsQuery.data?.length) {
    return (
      <p className="text-sm text-muted-foreground">
        No versions yet. Save the process to create the first version.
      </p>
    )
  }

  function handleClick() {
    navigate(buildWorkspacePath(workspace, `/processes/${processSlug}/history`))
  }
