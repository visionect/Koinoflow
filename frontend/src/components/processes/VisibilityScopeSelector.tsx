...
import { VISIBILITY_OPTIONS, groupDepartmentsByTeam } from "@/lib/process-visibility"
import type { TeamGroup } from "@/lib/process-visibility"
...
type VisibilityScopeSelectorProps = {
  ...
  onVisibilityChange: (v: ProcessVisibility) => void
  sharedWithIds: Set<string>
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <Label>Who can see this process</Label>
        <RadioGroup
          value={visibility}
          onValueChange={(v) => {
            onVisibilityChange(v as ProcessVisibility)
